      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 bg-[#F5FAFA] rounded-lg shadow-sm shadow-header-top/5 p-6 sm:p-8">
          ...
          <div className="overflow-hidden rounded-lg">
            <div className="grid grid-cols-[1.2fr_.7fr_auto] bg-[#EAF6F7] px-6 py-3 gap-4">
          ...
          <div className="mt-5 flex flex-col gap-3 pt-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
              ...
              <div className="flex gap-2">
                <div className="h-10 w-20 rounded-md bg-[#E8EEF2]" />
                <div className="h-10 w-24 rounded-md bg-[#D8F0F2]" />
              </div>
            </div>
          </div>
        </div>
